...
$string['see_analytics_for'] = 'Ver analíticas de aprendizaje de ';
$string['see_by_student'] = 'Analíticas por estudiante';
$string['see_by_group'] = 'Analíticas por grupo';
$string['see_by_class'] = 'Analíticas de clase';

$string['analytics_for'] = 'Analíticas de %';

$string['student_allowed'] = 'Acceso de estudiantes a analíticas';
$string['student_allowed_description'] = 'Si se activa, los estudiantes podrán ver sus analíticas de aprendizaje para el curso.';
